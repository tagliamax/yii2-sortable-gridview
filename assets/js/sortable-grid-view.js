(function ($) {
	$.SortableGridView = function (options) {
		...
		$('body').append('<div class="modal fade" id="' + options.id + '-sorting-modal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-body">' + options.sortingPromptText + '</div></div></div></div>');

		// var regex = /items\[\]\_(\d+)/;
		var loadingModal = $('#' + options.id + '-sorting-modal');
